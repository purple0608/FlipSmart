...
import { Menu, X, Search, Share, Shield, TrendingUp } from "lucide-react";
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      {/* Header */}
      <header className="topbar bg-white shadow-sm border-b border-gray-200 px-4 py-3">
          ...
          <div className="p-6">
            <div className="space-y-4">
              {filterItems.map((item, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between text-sm hover:text-[#b3ccff] cursor-pointer"
                >
                  <span>{item}</span>
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="bg-white border-b border-gray-200 px-4 py-6">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-7 h-7 bg-[#2a4e96] rounded flex items-center justify-center">
            ...
            {/* Search Bar */}
            <div className="search-bar relative max-w-4xl">
          ...
          <div className="p-4 space-y-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              ...
              <div className="salary-graph bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="mt-6 space-y-4 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <div className="bg-[#eaf1ff] px-2 py-1 rounded text-xs font-medium">
                        Mean Salary
                      </div>
                    </div>
                    <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div className="expected-salary-graph bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-gray-900">
                    Expected Salary Distribution
                  </h3>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
              {/* Median Salary */}
              <div className="median-salary-graph bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-4">
              ...
              <div className="diversity-graph bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-gray-900">
                    Diversity Distribution
                  </h3>
